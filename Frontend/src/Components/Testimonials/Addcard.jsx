...
export default function Addcard() {
    return (
        <div className="bg-white w-[320px] md:w-[1240px] h-[236px] md:h-[284px] mx-auto p-4 md:p-10 mt-44 md:mt-20 rounded-lg border-[1px] border-gray-400 flex flex-col gap-y-6 md:gap-y-10 ">
